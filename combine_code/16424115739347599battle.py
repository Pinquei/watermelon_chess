req_time_two = "16424115739347599"
#!/usr/bin/env python
# coding: utf-8
...
def AI_Score_Red_Side(board):
    ...
    if global_chess_position[global_yellow_side] == 1 or global_chess_position[global_yellow_side] == 2 or global_chess_position[global_yellow_side] == 3 or global_chess_position[global_yellow_side] == 5 or global_chess_position[global_yellow_side] == 7 or global_chess_position[global_yellow_side] == 8 or global_chess_position[global_yellow_side] == 14 or global_chess_position[global_yellow_side] == 15 or global_chess_position[global_yellow_side] == 17 or global_chess_position[global_yellow_side] == 19 or global_chess_position[global_yellow_side] == 20 or global_chess_position[global_yellow_side] == 21:
      score = (score - 50)
    elif global_chess_position[global_yellow_side] == 0:
      pass
    else:
      score = (score + 50)
    if global_red_side != 0:
      if fun_Alive(fun_Group(global_red_side)) == False:
        pass
    global_red_side=0
    global_yellow_side=1
    return score
...
def AI_Score_Yellow_Side(board):
    ...
    for C0C1C2C3 in board[global_red_side]:
      if C0C1C2C3 != 0:
        if fun_Alive(fun_Group(C0C1C2C3)) == False:
          score = (score + 100)
        if len([]) == 1:
          for C8C9C10C11 in Neighbor(C0C1C2C3):
            global_x = C8C9C10C11
            if Exist_Chess(global_x) == 2:
              score = (score + 50)
    for C12C13C2C3 in temp_board[global_yellow_side]:
      if C12C13C2C3 != 0:
        if C12C13C2C3 == 20 or Exist_Chess(17) == 1 or Exist_Chess(21) == 1 or Exist_Chess(18) == 1:
          score = (score - 70)
        if C12C13C2C3 == 19 or Exist_Chess(15) == 1 or Exist_Chess(21) == 1 or Exist_Chess(18) == 1:
          score = (score - 70)
        if C12C13C2C3 == 15 or Exist_Chess(19) == 1 or Exist_Chess(8) == 1 or Exist_Chess(9) == 1:
          score = (score - 70)
        if C12C13C2C3 == 5 or Exist_Chess(2) == 1 or Exist_Chess(8) == 1 or Exist_Chess(9) == 1:
          score = (score - 70)
        if C12C13C2C3 == 2 or Exist_Chess(5) == 1 or Exist_Chess(1) == 1 or Exist_Chess(4) == 1:
          score = (score - 70)
        if C12C13C2C3 == 3 or Exist_Chess(7) == 1 or Exist_Chess(1) == 1 or Exist_Chess(4) == 1:
          score = (score - 70)
        if C12C13C2C3 == 17 or Exist_Chess(20) == 1 or Exist_Chess(13) == 1 or Exist_Chess(14) == 1:
          score = (score - 70)
        if C12C13C2C3 == 11 or C12C13C2C3 == 10 or C12C13C2C3 == 9 or C12C13C2C3 == 16 or C12C13C2C3 == 4 or C12C13C2C3 == 6 or C12C13C2C3 == 13 or C12C13C2C3 == 18 or C12C13C2C3 == 12:
          score = (score + 30)
        elif C12C13C2C3 == 21 or Exist_Chess(20) == 1 or Exist_Chess(18) == 1 or Exist_Chess(19) == 1 or Exist_Chess(18) == 1 or Exist_Chess(19) == 1 or Exist_Chess(20) == 1:
          score = (score - 70)
        elif C12C13C2C3 == 14 or Exist_Chess(7) == 1 or Exist_Chess(13) == 1 or Exist_Chess(7) == 1 or Exist_Chess(17) == 1 or Exist_Chess(13) == 1 or Exist_Chess(17) == 1:
          score = (score - 70)
        elif C12C13C2C3 == 1 or Exist_Chess(2) == 1 or Exist_Chess(3) == 1 or Exist_Chess(2) == 1 or Exist_Chess(4) == 1 or Exist_Chess(3) == 1 or Exist_Chess(4) == 1:
          score = (score - 70)
        elif C12C13C2C3 == 8 or Exist_Chess(5) == 1 or Exist_Chess(9) == 1 or Exist_Chess(5) == 1 or Exist_Chess(15) == 1 or Exist_Chess(9) == 1 or Exist_Chess(15) == 1:
          score = (score - 70)
        if len([]) >= 2:
          score = (score + 30)
    global_red_side=0
