req_time_two = "16423185098714437"
#!/usr/bin/env python
# coding: utf-8
...
def AI_Score_Red_Side(board):
    ...
    for C0C1C2C3 in global_chess_position[global_yellow_side]:
      if C0C1C2C3 == 6 or C0C1C2C3 == 10 or C0C1C2C3 == 11 or C0C1C2C3 == 12:
        score = (score + 10)
      elif C0C1C2C3 == 4 or C0C1C2C3 == 9 or C0C1C2C3 == 13 or C0C1C2C3 == 14:
        score = (score + 5)
    ...
    for C0C1C2C3 in temp_board[global_yellow_side]:
      if C0C1C2C3 != 0:
        if C0C1C2C3 == 11:
          ...
          score = (score + 50)
        elif C0C1C2C3 == 6 or C0C1C2C3 == 10 or C0C1C2C3 == 12 or C0C1C2C3 == 16:
          score = (score + 20)
        else:
          score = (score + 0)
