req_time_two = "16424073295035725"
#!/usr/bin/env python
# coding: utf-8
...
def AI_Score_Red_Side(board):
    ...
    for C0C1C2C3 in global_chess_position[global_red_side]:
      if C0C1C2C3 != 0 and fun_Alive(fun_Group(C0C1C2C3)) == False:
        score = (15 + score)
    for C8C9C2C3 in global_chess_position[global_yellow_side]:
      if C8C9C2C3 == 6 or C8C9C2C3 == 10:
        score = (random.randint(10, 12) + score)
      elif C8C9C2C3 == 4 or C8C9C2C3 == 9:
        score = (random.randint(10, 12) + score)
      elif C8C9C2C3 == 1 or C8C9C2C3 == 2:
        score = (random.randint(7, 10) + score)
      elif len([]) < 4:
        score = (random.randint(-8, -5) + score)
      else:
        score = (random.randint(-12, -10) + score)
    for C0C1C2C3 in global_chess_position[global_red_side]:
      # C10C11C0C1C12C13C14
      # C10C11C15C12C16C17C18
      # C10C11C15C12C16C17C18
      # C10C11C15C12C16C17C18
      # C10C11C15C12C16C17C18
      # C10C11C19C20C21C22C15
      # C10C11C19C20C21C22C15，C23C19C24C25C26C27
      # C10C11C28C29C12C19C20C30C15C31C32
      # C10C11C28C29C12C19C20C30C15C31C32
      # C10C11C28C29C12C19C20C30C15C31C32
      # C10C11C28C29C12C19C20C30C15C31C32
      # C10C11C28C29C12C19C20C30C15C31C32
      ...
      # C10C11C28C29C12C19C20C30C15C31C32
      # C10C11C28C29C12C19C20C30C15C31C32
      if Exist_Chess(5) == 2 and Exist_Chess(6) == 2:
        score = (random.randint(10, 12) + score)
      elif Exist_Chess(15) == 2 and Exist_Chess(16) == 2:
        pass
      elif Exist_Chess(19) == 2 and Exist_Chess(10) == 2:
        score = (random.randint(6, 10) + score)
      elif Exist_Chess(20) == 2 and Exist_Chess(12) == 2:
        score = (random.randint(5, 8) + score)
      elif Exist_Chess(10) == 2 and Exist_Chess(11) == 2:
        score = (-100 + score)
      elif Exist_Chess(10) == 2 and Exist_Chess(11) == 0:
        score = (-40 + score)
      elif Exist_Chess(10) == 2 and Exist_Chess(11) == 1:
        score = (60 + score)
      elif Exist_Chess(19) == 2 and Exist_Chess(21) == 2 or Exist_Chess(19) == 2 and Exist_Chess(21) == 2 or Exist_Chess(19) == 2 and Exist_Chess(21) == 2:
        score = (-60 + score)
      elif Exist_Chess(20) == 2 and Exist_Chess(14) == 1 or Exist_Chess(19) == 2 and Exist_Chess(15) == 1 or False:
        score = (-20 + score)
      elif Exist_Chess(6) == 1 and Exist_Chess(12) == 1 or Exist_Chess(16) == 1 and Exist_Chess(10) == 1:
        score = (-50 + score)
      elif Exist_Chess(1) == 2 and Exist_Chess(2) == 1 or Exist_Chess(1) == 2 and Exist_Chess(2) == 1:
        score = (-50 + score)
      elif Exist_Chess(1) == 1 and Exist_Chess(2) == 1:
        score = (100 + score)
      elif False:
        pass
    global_red_side=0
