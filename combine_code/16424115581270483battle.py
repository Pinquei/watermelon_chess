req_time_two = "16424115581270483"
#!/usr/bin/env python
# coding: utf-8
    ...
    for C0C1C2C3 in board[global_red_side]:
      if C0C1C2C3 != 0:
        if fun_Alive(fun_Group(C0C1C2C3)) == False:
          score = (score + 30)
    for C8C9C2C3 in global_chess_position[global_yellow_side]:
      if C8C9C2C3 != 0:
        for C8C9C2C3C10C11 in Neighbor(C8C9C2C3):
          if Exist_Chess(C8C9C2C3C10C11) == 1:
            score = (score + 20)
          elif Exist_Chess(C8C9C2C3C10C11) == 2:
            score = (score + 10)
          else:
            score = (score + -10)
        if C8C9C2C3 == 4 or C8C9C2C3 == 9 or C8C9C2C3 == 13 or C8C9C2C3 == 18:
          score = (score + 10)
        elif C8C9C2C3 == 6 or C8C9C2C3 == 10 or C8C9C2C3 == 11 or C8C9C2C3 == 12 or C8C9C2C3 == 16:
          score = (score + 10)
        else:
          score = (score - 10)
    global_red_side=0
